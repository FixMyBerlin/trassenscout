  ...
  pages: [
    ...
    },
    {
      ...
      questions: [
        {
          id: 6,
          label: { de: "Wie wichtig ist Ihnen die Beleuchtung des FRM 7?" },
      ...
      buttons: [
        { label: { de: "Weiter" }, color: "blue", onClick: { action: "nextPage" } },
    ...
    },
    {
      ...
      description: {
        de: "Leider wird es nicht überall möglich sein, Wege zu bauen, die ausschließlich dem Radverkehr vorbehalten sind. Wir möchten gerne von Ihnen wissen, welche Folgen das für Ihre Nutzung des FRM 7 hätte.",
      },
      questions: [
        {
          id: 9,
        ...
        },
        {
          id: 13,
          label: {
            de: "Einen Radweg, der auch von Kutschen befahren werden darf, würde ich …",
          },
          component: "singleResponse",
          props: {
            responses: [
      ...
      buttons: [
        { label: { de: "Absenden" }, color: "blue", onClick: { action: "submit" } },
        { label: { de: "Zurück" }, color: "white", onClick: { action: "previousPage" } },
      ],
    },
  ],
