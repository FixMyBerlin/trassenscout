...
export const surveyDefinition: TSurvey = {
  ...
  atlasUrl:
    "https://radverkehrsatlas.de/regionen/bb-pg?map=MAPPARAM&config=z9tzbb.172uzo.i&data=bb-land-klassifiertes-strassennetz,bb-ramboll-netzentwurf-2,bb-ramboll-quellen-ziele,bb-ramboll-netzentwurf-2-beteiligung&v=2",
  primaryColor: "#C73C35",
  darkColor: "#651E1B",
  lightColor: "#DF8A86",
