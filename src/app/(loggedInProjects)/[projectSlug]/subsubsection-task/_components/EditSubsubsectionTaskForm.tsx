...
export const EditSubsubsectionTaskForm = ({ subsubsectionTask, projectSlug, fromParam }: Props) => {
  ...
  type HandleSubmit = z.infer<typeof SubsubsectionTask>
  ...
  return (
    <>
      <SubsubsectionTaskForm
        ...
        actionBarRight={
          <DeleteActionBar
            itemTitle={subsubsectionTask.title}
            onDelete={() =>
              deleteSubsubsectionTaskMutation({ id: subsubsectionTask.id, projectSlug })
            }
