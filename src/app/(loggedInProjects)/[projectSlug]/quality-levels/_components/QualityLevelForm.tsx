...
import { qualityLevelFormDefaultValues } from "@/src/server/qualityLevels/schema"
import { ReactNode, useState } from "react"
import { z } from "zod"

export type QualityLevelFormProps<S extends z.ZodType<any, any>> = {
  schema: S
  ...
  return (
    ...
    >
      ...
      <form.AppField name="url">
        {(field) => <field.TextField type="text" label="Externer Link" optional />}
      </form.AppField>
