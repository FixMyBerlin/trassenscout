        ...
        {({ open }) => (
          <div className="relative mt-1">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <ListboxOptions className="ring-opacity-5 absolute z-50 mt-1 max-h-60 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black focus:outline-hidden sm:text-sm">
