  ...
  private convertGeometryToFeatures(geometry: Geometry) {
    ...
    switch (geometry.type) {
      ...
      case "MultiPoint":
        ...
        ;(geometry as any).coordinates.forEach((coords: any) => {
          features.push({
            type: "Feature" as const,
            properties: { mode: "point" },
  ...
  onAdd(map: MapLibreMap) {
    this.draw = new TerraDraw({
      ...
      modes: [
        ...
        new TerraDrawPointMode({ styles: { pointColor: "#B377FE" } }),
        new TerraDrawLineStringMode({ styles: { lineStringColor: "#B377FE" } }),
        new TerraDrawFreehandLineStringMode({ styles: { lineStringColor: "#B377FE" } }),
        new TerraDrawPolygonMode({ styles: { outlineColor: "#B377FE" } }),
        new TerraDrawSelectMode({
          ...
          styles: {
            ...
            selectedPointColor: "#B377FE",
            selectionPointColor: "#B377FE",
            selectedLineStringColor: "#333333",
            selectedPolygonColor: "#333333",
          },
        }),
      ],
    })
 ...
 */
export const useTerraDrawControl = ({ initialGeometry, onChange }: UseTerraDrawControlProps) => {
