...
import { subsubsectionInfrastructureTypeFormDefaultValues } from "@/src/shared/subsubsectionInfrastructureType/schemas"

export type SubsubsectionInfrastructureTypeFormProps<S extends z.ZodType> = {
  schema: S
...
export function SubsubsectionInfrastructureTypeForm<S extends z.ZodType>({
  schema,
  initialValues,
  onSubmit,
  submitText,
