...
import { subsubsectionTaskFormDefaultValues } from "@/src/shared/subsubsectionTask/schemas"

export type SubsubsectionTaskFormProps<S extends z.ZodType> = {
  schema: S
...
export function SubsubsectionTaskForm<S extends z.ZodType>({
  schema,
  initialValues,
  onSubmit,
  submitText,
  ...
  submitDisabled,
  submitClassName,
}: SubsubsectionTaskFormProps<S>) {
  const [formError, setFormError] = useState<string | null>(null)

  const form = useAppForm({
    defaultValues: { ...subsubsectionTaskFormDefaultValues, ...initialValues },
