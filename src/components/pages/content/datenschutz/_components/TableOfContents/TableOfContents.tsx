...
export const TableOfContents: React.FC<Props> = ({ items }) => {
  return (
    <div className="xl:pointer-events-none xl:absolute xl:inset-y-0 xl:left-0 xl:z-10 xl:w-60">
      <nav
        arial-title="Inhaltsverzeichnis"
        className="xl:not-prose xl:pointer-events-auto xl:sticky xl:top-28 xl:rounded-sm xl:rounded-l-none xl:bg-white xl:px-4 xl:py-3 xl:shadow-lg"
      >
