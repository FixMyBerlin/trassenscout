    ...
    <>
      ...
      <div className={pageContentPaddingClassName}>
        <div className="mb-8 max-w-3xl">
          ...
          <p>
            Entscheiden Sie für jedes Dokument, ob es zusammen mit dem Protokolleintrag gelöscht
            oder unabhängig vom Protokolleintrag gespeichert werden soll. Beachten Sie, dass
            Dokumente auch mit weitere Verknüpfungen haben können.
          </p>
        </div>
      </div>
