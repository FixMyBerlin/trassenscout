      ...
      <form.Subscribe selector={(state) => state.values.config.sections}>
        {(sections) => (
          <div className="space-y-4">
            {sections.map((section, index) => (
              ...
              >
                <div className="mb-4 flex flex-col gap-3 border-b border-gray-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
                  <h2 className="text-base font-semibold text-gray-900">Element {index + 1}</h2>
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      title="Nach oben"
                      aria-label={`Element ${index + 1} nach oben verschieben`}
                    >
                    ...
                    <button
                      ...
                      title="Nach unten"
                      aria-label={`Element ${index + 1} nach unten verschieben`}
                    >
                    ...
                    <button
                      ...
                      title="Duplizieren"
                      aria-label={`Element ${index + 1} duplizieren`}
                    >
                    ...
                    <button
                      ...
                      title="Löschen"
                      aria-label={`Element ${index + 1} löschen`}
                    >
            ...
            <ZeroCase small visible={sections.length} name="Elemente" verb="angelegt" />
