...
} from "@/src/components/beteiligung/links/styles"
...
import institutions_bboxes from "@/src/components/beteiligung/surveys/radnetz-brandenbrug/institutions_bboxes.json"
import { SurveyH1, SurveyH2, SurveyH3, SurveyP } from "@/src/components/beteiligung/Text"
...
export const SurveyBB = ({ surveyId }: Props) => {
  ...
  useEffect(
    function syncInstitutionSearchParams() {
      const url = new URL(window.location.href)
      url.searchParams.set("id", id)
      url.searchParams.set("institution", institution)
      url.searchParams.set("landkreis", landkreis)
      window.history.replaceState({}, "", url)
    },
    [id, institution, landkreis],
  )
