...
import { part1Config } from "@/src/components/beteiligung/surveys/radnetz-brandenbrug/part1"
import { part2Config } from "@/src/components/beteiligung/surveys/radnetz-brandenbrug/part2"
...
export const formConfig: FormConfig = {
  meta: {
    ...
    tildaUrl:
      "https://tilda-geo.de/regionen/bb-sg?map=MAPPARAM&config=z9tzbb.172uzo.i&data=bb-trassenscout-beteiligung,bb-ramboll-netzentwurf-2,bb-land-klassifiertes-strassennetz&v=2",
    primaryColor: "#C73C35",
    darkColor: "#651E1B",
    lightColor: "#DF8A86",
  },
