      ...
      <form.AppField name="operatorId">
        {(field) => (
          <field.SelectField
            ...
            trailingControl={
              <LinkWithFormDirtyConfirm to={`/${projectSlug}/operators`}>
      ...
      <form.AppField name="subsectionStatusId">
        {(field) => (
          <field.SelectField
            ...
            trailingControl={
              <LinkWithFormDirtyConfirm to={`/${projectSlug}/subsection-status`}>
                Status verwalten…
              </LinkWithFormDirtyConfirm>
            }
          />
      ...
      <form.AppField name="networkHierarchyId">
        {(field) => (
          <field.SelectField
            ...
            trailingControl={
              <LinkWithFormDirtyConfirm to={`/${projectSlug}/network-hierarchy`}>
