...
import { subsubsectionInfraFormDefaultValues } from "@/src/shared/subsubsectionInfra/schemas"

export type SubsubsectionInfraFormProps<S extends z.ZodType> = {
  schema: S
...
export function SubsubsectionInfraForm<S extends z.ZodType>({
  schema,
  initialValues,
  onSubmit,
  submitText,
  ...
  submitDisabled,
  submitClassName,
}: SubsubsectionInfraFormProps<S>) {
  const [formError, setFormError] = useState<string | null>(null)

  const form = useAppForm({
    defaultValues: { ...subsubsectionInfraFormDefaultValues, ...initialValues },
