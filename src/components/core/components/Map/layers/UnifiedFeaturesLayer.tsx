...
import { mapLayerColorConfigs } from "@/src/components/core/components/Map/colors/mapLayerColorConfigs"
 ...
 */
export function getUnifiedClickTargetLayerIds(suffix: string) {
