...
import {
  useTerraDrawHintActions,
  useTerraDrawHintDismissedIds,
  useTerraDrawHintGeometryType,
  useTerraDrawHintMode,
} from "@/src/components/core/components/Map/TerraDraw/terra-draw-hint-store"
...
export const TerraDrawHint = () => {
  const mode = useTerraDrawHintMode()
  const geometryType = useTerraDrawHintGeometryType()
  const dismissedIds = useTerraDrawHintDismissedIds()
  const { dismiss } = useTerraDrawHintActions()
