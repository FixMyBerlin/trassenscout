...
import { LineEndPointsLayer } from "@/src/components/core/components/Map/layers/LineEndPointsLayer"
import { SubsectionHullsLayer } from "@/src/components/core/components/Map/layers/SubsectionHullsLayer"
import {
  UnifiedFeaturesLayer,
  type UnifiedFeatureProperties,
} from "@/src/components/core/components/Map/layers/UnifiedFeaturesLayer"
import { getSubsectionFeatures } from "@/src/components/core/components/Map/utils/getSubsectionFeatures"
import { getSubsubsectionFeatures } from "@/src/components/core/components/Map/utils/getSubsubsectionFeatures"
import { mergeFeatureCollections } from "@/src/components/core/components/Map/utils/mergeFeatureCollections"
import type {
  SubsectionMapEntities as TSubsections,
  SubsubsectionMapEntity as SubsubsectionWithPosition,
} from "../mapEntityTypes"

const ALKIS_ATTRIBUTION =
  'ALKIS Daten © <a href="https://www.geobasis-bb.de/lgb/de/" target="_blank" rel="noreferrer">LGB Brandenburg</a>'
...
function singleGeometryFeatureCollection<T extends Geometry>(geometry: T) {
