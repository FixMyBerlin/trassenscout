  ...
  return (
    <div className="relative">
      <LabeledTextareaField
        help="Formatierung in Markdown ist möglich"
        optional
        rows={12}
        name="summary"
      ...
      {uploadId && (
        <button
          ...
          disabled={isGeneratingSummary}
          className="absolute right-2 top-8 flex items-center gap-1 rounded bg-blue-600 px-2 py-1 text-xs text-white hover:bg-blue-700 disabled:opacity-50"
        >
